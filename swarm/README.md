...
Building Swarm requires Go (version 1.10 or later).
    ...
    go get -d github.com/portto/go-tangerine

    go install github.com/portto/go-tangerine/cmd/swarm
...
You must have your working copy under `$GOPATH/src/github.com/portto/go-tangerine`.
...
```
git clone git@github.com:nirname/go-ethereum.git $GOPATH/src/github.com/portto/go-tangerine
```
...
```
stateth --rm --grafana-dashboards-folder $GOPATH/src/github.com/portto/go-tangerine/swarm/grafana_dashboards --influxdb-database metrics
```
 ...
 * [Code review guidelines](https://github.com/portto/go-tangerine/wiki/Code-Review-Guidelines).
